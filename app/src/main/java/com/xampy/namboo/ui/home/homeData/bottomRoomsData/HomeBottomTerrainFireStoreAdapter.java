...
public class HomeBottomTerrainFireStoreAdapter extends FirestoreRecyclerAdapter<PostNambooFirestore, HomeBottomTerrainFireStoreAdapter.PostViewHolder> {
   ...
   private PostTerrainInteractionListener mListener;
    ...
    public HomeBottomTerrainFireStoreAdapter(
            @NonNull FirestoreRecyclerOptions<PostNambooFirestore> options,
            RequestManager glide,
            TerrainListener callback, PostTerrainInteractionListener listener,
            String uid,
            Context context) {
    ...
    protected void onBindViewHolder(
            @NonNull final HomeBottomTerrainFireStoreAdapter.PostViewHolder holder,
            int position,
    ...
    @NonNull
    @Override
    public HomeBottomTerrainFireStoreAdapter.PostViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return  new HomeBottomTerrainFireStoreAdapter.PostViewHolder(
