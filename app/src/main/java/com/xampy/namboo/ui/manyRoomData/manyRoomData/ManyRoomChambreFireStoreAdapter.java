...
public class ManyRoomChambreFireStoreAdapter
        extends FirestoreRecyclerAdapter<PostNambooFirestore, ManyRoomChambreFireStoreAdapter.PostViewHolder> {

    private final Context mContext;
    private final RequestManager glide;
    private final ChambreListener callback;
    private final String uid;
    LayoutInflater mLayoutInflater;

    public interface ChambreListener {
        void onDataChanged();

    }

   public interface ManyChambreInteractionListener {
        void onClicked(PostNambooFirestore post);
   }

   private ManyChambreInteractionListener mListener;


    public ManyRoomChambreFireStoreAdapter(
            @NonNull FirestoreRecyclerOptions<PostNambooFirestore> options,
            RequestManager glide,
            ChambreListener callback,  ManyChambreInteractionListener listener,
            String uid,
            Context context) {
    ...
    protected void onBindViewHolder(
            @NonNull final ManyRoomChambreFireStoreAdapter.PostViewHolder holder,
            int position,
    ...
    @NonNull
    @Override
    public ManyRoomChambreFireStoreAdapter.PostViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return  new ManyRoomChambreFireStoreAdapter.PostViewHolder(
