...
public class ManyRoomMaisonFireStoreAdapter
        extends FirestoreRecyclerAdapter<PostNambooFirestore, ManyRoomMaisonFireStoreAdapter.PostViewHolder> {
   ...
   public interface ManyMaisonInteractionListener {
        void onClicked(PostNambooFirestore post);
   }

   private ManyMaisonInteractionListener mListener;


    public ManyRoomMaisonFireStoreAdapter(
            @NonNull FirestoreRecyclerOptions<PostNambooFirestore> options,
            RequestManager glide,
            TerrainListener callback,  ManyMaisonInteractionListener listener,
            String uid,
            Context context) {
    ...
    protected void onBindViewHolder(
            @NonNull final ManyRoomMaisonFireStoreAdapter.PostViewHolder holder,
            int position,
    ...
    @NonNull
    @Override
    public ManyRoomMaisonFireStoreAdapter.PostViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return  new ManyRoomMaisonFireStoreAdapter.PostViewHolder(
