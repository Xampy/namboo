...
public class ManyRoomTerrainFireStoreAdapter
        extends FirestoreRecyclerAdapter<PostNambooFirestore, ManyRoomTerrainFireStoreAdapter.PostViewHolder> {
   ...
   private ManyTerrainInteractionListener mListener;
    ...
    public ManyRoomTerrainFireStoreAdapter(
            @NonNull FirestoreRecyclerOptions<PostNambooFirestore> options,
            RequestManager glide,
            TerrainListener callback,  ManyTerrainInteractionListener listener,
            String uid,
            Context context) {
    ...
    protected void onBindViewHolder(
            @NonNull final ManyRoomTerrainFireStoreAdapter.PostViewHolder holder,
            int position,
    ...
    @NonNull
    @Override
    public ManyRoomTerrainFireStoreAdapter.PostViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return  new ManyRoomTerrainFireStoreAdapter.PostViewHolder(
